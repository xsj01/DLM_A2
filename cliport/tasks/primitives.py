...
def move_to(movej, movep, ee, pos, rot, speed=0.01):  # pylint: disable=unused-argument
  """Execute pushing primitive (sjxue).
  ...
  #pos, rot = pose
  pose = (pos, rot)
  timeout = movep(pose, speed=speed)
  return timeout